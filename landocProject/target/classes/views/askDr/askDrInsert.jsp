...
<body>
	...
	<section class="playlist-section">
		...
		<div class="container">
			...
			<form class="form-horizontal" action="askDrInsert.do" method="post">
				<div class="form-group form-inline">
					<label for="category" class="col-sm-3 control-label"> 진료과목
					</label> <select id="category" name="categoryCode" class="form-control"
						required>
				...
				<div class="form-group form-inline">
					...
					<textarea name="caution" 
						class="form-control col-sm-9" style="max-width: 70%;"
						placeholder="복용중인 약 혹은 주의사항을 상세히 기재해 주세요. 해당 입력칸은 빈칸으로 제출하셔도 됩니다.">
					</textarea>
				</div>
				<div class="form-group form-inline">
					...
					<textarea name="symptoms" 
						class="form-control col-sm-9" style="max-width: 70%;"
						rows="10" placeholder="증상을 구체적으로 작성해주세요.">
					</textarea>
				</div>
				<div class="form-group form-inline">
